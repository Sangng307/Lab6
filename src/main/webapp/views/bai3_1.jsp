...
<body>
	<div class="container col-7 pt-2">
		<div class="border rounded bg-light pl-4 pr-4 p-3">
			...
			<div class="row">
				<div class="col">
					<form action="/JAVA4LAB6/findKeyNamed" method="post">
						<div class="form-group pt-2">
							<label>Tìm kiếm:</label> <input type="text" name="keyword" placeholder="keyword"
								class="form-control" />
						</div>
						<div class="form-group pt-2">
							<button class="btn btn-danger mr-2">Find by Keyword</button>													
						</div>
